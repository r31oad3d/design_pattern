...
fn main() {
    ...
    let mut head_sales = Employee::new("Robert".to_owned(),"Head Sales".to_owned(), 20000);

    let mut head_marketing = Employee::new("Robert".to_owned(),"Head Sales".to_owned(), 20000);
    let clerk1 = Employee::new("Laura".to_owned(),"Marketing".to_owned(), 10000);
    let clerk2 = Employee::new("Bob".to_owned(),"Marketing".to_owned(), 10000);

    let sales_executive1 = Employee::new("Richard".to_owned(),"Sales".to_owned(), 10000);
    let sales_executive2 = Employee::new("Rob".to_owned(),"Sales".to_owned(), 10000);
